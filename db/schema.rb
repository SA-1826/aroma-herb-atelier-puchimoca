...
ActiveRecord::Schema.define(version: 2024_12_04_151909) do
  ...
  create_table "inquiries", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["user_id", "status"], name: "index_inquiries_on_user_id_and_status", unique: true
  end
  ...
  create_table "user_group_combinations", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["user_id", "group_id"], name: "index_user_group_combinations_on_user_id_and_group_id", unique: true
  end
