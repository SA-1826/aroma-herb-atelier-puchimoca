...
admin = Admin.create!(email: "admin@test.com", password: "adminpassword")
...
programs_attributes = [
  ...
  {
    category: Category.find_by(name: "資格対応ーアロマ"),
  ...
  {
    category: Category.find_by(name: "資格対応ーハーブ"),
    title: "ハーバルセラピスト認定講座",
